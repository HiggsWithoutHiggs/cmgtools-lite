...
def scalarToVector(x):
    x0 = x
    x = re.sub(r"(LepGood|Lep|LepClean_Recl|JetFwd|Jet|GenTop|SV|PhoGood|TauGood|Tau|Muon|Electron)(\d)_(\w+)", lambda m : "%s_%s[%d]" % (m.group(1),m.group(3),int(m.group(2))-1), x)
